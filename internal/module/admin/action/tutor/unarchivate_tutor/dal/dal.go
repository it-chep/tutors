...
// UnArchivateTutor разархивирование репетитора
func (r *Repository) UnArchivateTutor(ctx context.Context, tutorID int64) error {
	sql := `update tutors set is_archive = false where id = $1`
