package unarchivate_student

import (
	"context"
	"github.com/it-chep/tutors.git/internal/module/admin/action/student/unarchivate_student/dal"
...
func (a *Action) adminUnArchivate(ctx context.Context, studentID int64) error {
	...
	if !student.IsArchived {
		return errors.New("student already unarchived")
	}

	err = a.dal.UnArchivateStudent(ctx, studentID)
	if err != nil {
		return err
	}
